<template>
  <div class="bg-white rounded-2xl shadow-md p-6 space-y-5 animate-fade-in">
    <div>
      <p class="text-xs font-semibold text-gray-400 uppercase tracking-wide mb-1">You said</p>
      <p class="text-gray-700">{{ result.original }}</p>
    </div>
